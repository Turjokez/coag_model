...
## Current Defaults (Modeling)

These are the current working defaults used in recent diagnostics:

- Sinking law: `kriest_8`
- Disaggregation: ON, `c3 = 0.02`, `c4 = 1.45` (treated as loss term)
- Geometry: `r_to_rg = 1.6`
- Diagnostics time step: `delta_t = 0.25`
- Box depth: `2000` m
